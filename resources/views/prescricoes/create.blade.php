    ...
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                Nova Prescricao — {{ $patient->nome_completo }}
            </h2>
        </div>
    </x-slot>
    ...
    <div class="py-6">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <x-clinic-card>
                ...
                <form method="POST" action="{{ route('patients.sessions.prescricao.store', [$patient, $session]) }}">
                    @csrf
                    ...
                    <div class="flex items-center justify-end gap-4 mt-6 pt-6 border-t border-gray-200">
                        ...
                        <x-primary-button>Salvar Rascunho</x-primary-button>
                    </div>
                </form>
            </x-clinic-card>
        </div>
