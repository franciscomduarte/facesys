<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-4">
            <a href="{{ route('templates-contrato.show', $template) }}" class="text-gray-500 hover:text-gray-700">
